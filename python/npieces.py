...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', dest='inputs', metavar='image', type=str, nargs='+', required=True, help='input image file(s)')
    ...
    parser.add_argument('-s', dest='shift', metavar='shift', type=int, required=False, default=0, help='shift pixels count')
