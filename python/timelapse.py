...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', dest='scale', metavar='scale', type=str, default='1920:1080', help='output video size (default: 1920:1080)')
    parser.add_argument('-o', dest='output', metavar='output', type=str, default='render.mp4', help='output video file (default: render.mp4')
